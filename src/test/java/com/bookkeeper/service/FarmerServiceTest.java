...
class FarmerServiceTest {
    ...
    void testAddAndGetFarmer() {
        Farmer f = service.addFarmer("Alice", "Wonderland", "12345", "Somewhere",
                new BigDecimal("0.10"), new BigDecimal("1000"), List.of("Rose", "Jasmine"));
    ...
    void testIdUniqueness() {
        ...
        Farmer f2 = service.addFarmer("Bob", "Builder", "22222", "Place2",
                BigDecimal.ONE, BigDecimal.ONE, List.of());
        assertEquals(f1.getId() + "_1", f2.getId());
    }

    @Test
    void testListFarmers() {
        service.addFarmer("A", "B", "", "", BigDecimal.ZERO, BigDecimal.ZERO, List.of());
        service.addFarmer("C", "D", "", "", BigDecimal.ZERO, BigDecimal.ZERO, List.of());
    ...
    void testUpdateFarmer() {
        Farmer f = service.addFarmer("Carl", "City", "", "", BigDecimal.ZERO, BigDecimal.ZERO, List.of());
        f.setContact("99999");
    ...
    void testRemoveFarmer() {
        Farmer f = service.addFarmer("Dave", "Town", "", "", BigDecimal.ZERO, BigDecimal.ZERO, List.of());
    ...
    void testRecordAdvanceSuccess() {
        Farmer f = service.addFarmer("Eve", "City", "", "", BigDecimal.ZERO, new BigDecimal("500"), List.of());
    ...
    void testRecordAdvanceOverLimit() {
        Farmer f = service.addFarmer("Adam", "Town", "", "", BigDecimal.ZERO, new BigDecimal("100"), List.of());
    ...
    void testRecordRepaymentSuccess() {
        Farmer f = service.addFarmer("Sam", "Ville", "", "", BigDecimal.ZERO, new BigDecimal("1000"), List.of());
    ...
    void testRecordRepaymentBelowZero() {
        Farmer f = service.addFarmer("Tom", "Town", "", "", BigDecimal.ZERO, new BigDecimal("100"), List.of());
